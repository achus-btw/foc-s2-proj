...
function resize() {
    ...
    c.width = box.width;
    c.height = box.height;
  diagLength=Math.sqrt(c.width*c.width+c.height*c.height);
}
...
roundedRect(ctx,x-r/2,y-r/2,r,r,r);
}
function draw() {
  ...
  circleDraw(ctx,c.width/2,c.height/2,diagLength*transitionStage)
  if(animatingTransition){
    transitionStage+=0.01
      if(transitionStage>1.5){
        transitionStage=0
      }
  }
